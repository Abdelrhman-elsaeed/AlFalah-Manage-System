...
public sealed class ReopenReferralCommandHandler
    : IRequestHandler<ReopenReferralCommand, ApiResponse<ReferralDto>>
{
    private readonly IReferralWorkflowRepository _repository;
    private readonly ICurrentUserService _currentUser;
    private readonly TimeProvider _timeProvider;

    public ReopenReferralCommandHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (string.IsNullOrWhiteSpace(request.Reason))
            return ApiResponse<ReferralDto>.Fail("Reopen reason is required");
        ...
        return ApiResponse<ReferralDto>.Success(dto, "Referral reopened successfully");
    }
}
