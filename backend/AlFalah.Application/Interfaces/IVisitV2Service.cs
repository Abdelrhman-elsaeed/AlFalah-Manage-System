...
public interface IVisitV2Service
{
    ...
    Task<VisitV2DetailDto> ApproveAsync(int id, CancellationToken cancellationToken = default);
    Task<VisitV2DetailDto> RejectAsync(int id, string reason, CancellationToken cancellationToken = default);
    Task<VisitV2DetailDto> ReopenAsync(int id, string reason, CancellationToken cancellationToken = default);
    ...
    Task<BulkExportResult> ExportZipAsync(VisitV2ArchiveQuery query, CancellationToken cancellationToken = default);
