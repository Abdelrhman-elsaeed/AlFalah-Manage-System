...
@Component({
  ...
  styles: [`
    ...
    /* PrimeNG renders the visual control inside the p-dropdown host.
       The previous direct-child selector only targeted the Angular host,
       leaving the real .p-dropdown at its intrinsic/minimum width. */
    .clearable-select ::ng-deep .p-dropdown {
