    ...
    <div class="page" dir="rtl">
      <header class="page-header">
        <div class="page-header__titles">
          <h1 class="page-header__title">{{ 'DASHBOARD.INSTRUCTOR' | translate }}</h1>
      ...
      <section class="surface-card dashboard-card">
        ...
        <h2 class="dashboard-card__title">{{ 'DASHBOARD.INSTRUCTOR' | translate }}</h2>
        <p class="dashboard-card__desc">سيتم تطوير لوحة المعلم في المرحلة التاسعة</p>
      </section>
    </div>
  `,
  styles: [`
