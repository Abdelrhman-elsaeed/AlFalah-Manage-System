    ...
    <div class="page" dir="rtl">
      <header class="page-header">
        <div class="page-header__titles">
          <h1 class="page-header__title">{{ 'DASHBOARD.MODERATOR' | translate }}</h1>
      ...
      <section class="surface-card dashboard-card">
        ...
        <h2 class="dashboard-card__title">{{ 'DASHBOARD.MODERATOR' | translate }}</h2>
        <p class="dashboard-card__desc">سيتم تطوير لوحة المشرف في المرحلة التاسعة</p>
      </section>
    </div>
  `,
  styles: [`
