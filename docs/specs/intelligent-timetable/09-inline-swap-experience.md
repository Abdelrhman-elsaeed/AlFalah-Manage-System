...
- إذا كان للأحمر اقتراح بديل قابل للتنفيذ، تظهر أزرار **موافقة وتنفيذ الاقتراح** و**لا، اختيار حصة أخرى**. الموافقة على الأخضر تنفذ الاقتراح تلقائيًا عبر endpoint التأكيد الحالي بعد إعادة تحقق الخادم، بينما الأصفر ينتقل أولًا لمراجعة التنبيهات وإدخال سبب التجاوز الإلزامي.
